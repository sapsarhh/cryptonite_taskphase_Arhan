...
Reffered to the following video for more information on both of the path types and higher conceptual clarity: https://www.youtube.com/watch?v=sB77xnFhsJs&ab_channel=TheLinuxJuggernaut
Firstly I run the following commands and arguments:
/challenge/run
Incorrect...
